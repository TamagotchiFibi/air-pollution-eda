...
исследовательские вопросы, а не только визуальное изучение данных.
...
- В городах с максимальным AQI основным указанным загрязнителем является **PM2.5**
  (PM2.5 является основным загрязнителем при значениях AQI 443-500).
...
Полный анализ с кодом, промежуточными проверками качества данных и визуализациями доступен в Jupyter Notebook:
`notebooks/air_quality_eda.ipynb`
